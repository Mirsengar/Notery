...
class app {
     ...
     public static
     class main {
          public static final String TAG = "Notery";
          public static final String URL = "http://Your local host IP/Notery/";
     }
     ...
     public static
     void t ( String message , ToastType type ) {
          
          switch ( type ) {
               case ERROR:
                    Toasty.error ( Application.getContext ( ) , message , Toast.LENGTH_LONG ).show ( ); break;
               case WARNING:
                    Toasty.warning ( Application.getContext ( ) , message , Toast.LENGTH_LONG ).show ( ); break;
               case SUCCESS:
                    Toasty.success ( Application.getContext ( ) , message , Toast.LENGTH_LONG ).show ( ); break;
               case NORMAL:
                    Toasty.normal ( Application.getContext ( ) , message , Toast.LENGTH_LONG ).show ( ); break;
               case INFO:
                    Toasty.info ( Application.getContext ( ) , message , Toast.LENGTH_LONG ).show ( ); break;
          }
     }
     
     
     public static
     Drawable getImage ( NoteObject note ) {
     ...
     public static
     void animateError ( View view ) {
          YoYo.with ( Techniques.Pulse ).duration ( 500 ).playOn ( view );
     }
     
     public static
     void changeNoteState (
               final int position , final NoteObject object ,
               final NoteStateChangeListener listener
                          ) {
